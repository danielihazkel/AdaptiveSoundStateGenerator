...
const GOAL_KEYWORDS: Array<[string, CoachGoal]> = [
  ...
  ['wind down', 'calm'],
  ['calm down', 'calm'],
  ['set the mood', 'intimacy'],
  ['in the mood', 'intimacy'],
  ['date night', 'intimacy'],
  ['study', 'study'],
  ['studying', 'study'],
  ['exam', 'study'],
  ...
  ['awake', 'energize'],
  ['pumped', 'energize'],
  // Deliberately no bare "arousal"/"aroused": in this app that word also means
  // alertness (desiredArousal, PRD §11) and would misfire.
  ['intimate', 'intimacy'],
  ['intimacy', 'intimacy'],
  ['sensual', 'intimacy'],
  ['sensuality', 'intimacy'],
